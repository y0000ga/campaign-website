var _a;
import { effectScope, reactive, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, version as version$1, unref, inject as inject$1, toRef, nextTick, shallowRef, shallowReactive, isReadonly, toRaw, isRef, isReactive, ref, markRaw, watch, computed, getCurrentScope, onScopeDispose, toRefs, isShallow, Fragment, watchEffect, capitalize, isVNode, Comment, warn, defineComponent as defineComponent$1, camelize, h, provide, createVNode, mergeProps, readonly, TransitionGroup, Transition, withDirectives, resolveDirective, vShow, Text, resolveDynamicComponent, Teleport, cloneVNode, createTextVNode, vModelText, Suspense, resolveComponent, withCtx, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, createApp } from "vue";
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/_...slug_-a21927e4.js").then((m) => m.default || m)
  },
  {
    name: "about",
    path: "/about",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-2cb59a7b.js").then((m) => m.default || m)
  },
  {
    name: "activity-id",
    path: "/activity/:id()",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-1aa038ef.js").then((m) => m.default || m)
  },
  {
    name: "activity",
    path: "/activity",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-c8e5a4df.js").then((m) => m.default || m)
  },
  {
    name: "donate",
    path: "/donate",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-665f4092.js").then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-de32bfb0.js").then((m) => m.default || m)
  },
  {
    name: "policy",
    path: "/policy",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-3b2792d0.js").then((m) => m.default || m)
  },
  {
    name: "service",
    path: "/service",
    ...
    alias: [],
    redirect: void 0,
    component: () => import("./_nuxt/index-7388cfa6.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-53e50424.js").then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-404-cf12949b.js").then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/error-500-a87c2d31.js").then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import("./_nuxt/island-renderer-bd965dcb.js").then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
