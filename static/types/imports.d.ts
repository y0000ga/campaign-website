...
export {}
declare global {
  const ACTION: typeof import('../../utils/constant')['ACTION']
  const ACTIVITY: typeof import('../../utils/constant')['ACTIVITY']
  const ADVOCATE: typeof import('../../utils/constant')['ADVOCATE']
  const ADVOCATE_CONTENT: typeof import('../../utils/constant')['ADVOCATE_CONTENT']
  const LEGISLATOR: typeof import('../../utils/constant')['LEGISLATOR']
  const NAV: typeof import('../../utils/constant')['NAV']
  const POLICY: typeof import('../../utils/constant')['POLICY']
  const PROMOTION: typeof import('../../utils/constant')['PROMOTION']
  const SOCIAL: typeof import('../../utils/constant')['SOCIAL']
  const TAIWAN_FUTURE: typeof import('../../utils/constant')['TAIWAN_FUTURE']
...
declare module 'vue' {
  interface ComponentCustomProperties {
    readonly ACTION: UnwrapRef<typeof import('../../utils/constant')['ACTION']>
    readonly ACTIVITY: UnwrapRef<typeof import('../../utils/constant')['ACTIVITY']>
    readonly ADVOCATE: UnwrapRef<typeof import('../../utils/constant')['ADVOCATE']>
    readonly ADVOCATE_CONTENT: UnwrapRef<typeof import('../../utils/constant')['ADVOCATE_CONTENT']>
    readonly LEGISLATOR: UnwrapRef<typeof import('../../utils/constant')['LEGISLATOR']>
    readonly NAV: UnwrapRef<typeof import('../../utils/constant')['NAV']>
    readonly POLICY: UnwrapRef<typeof import('../../utils/constant')['POLICY']>
    readonly PROMOTION: UnwrapRef<typeof import('../../utils/constant')['PROMOTION']>
    readonly SOCIAL: UnwrapRef<typeof import('../../utils/constant')['SOCIAL']>
    readonly TAIWAN_FUTURE: UnwrapRef<typeof import('../../utils/constant')['TAIWAN_FUTURE']>
