<template>
  <div>
    ...
    >
      <div
        class="w-100 d-flex justify-space-between align-center py-2 px-3 rounded-xl"
      ...
      >
        ...
        <div class="d-flex">
          <v-btn
            class="rounded-pill px-0 actions"
            style="height: 60px; width: 48px"
            variant="text"
            v-for="item in SOCIAL.slice(0, 3)"
            ><v-icon
    ...
    <v-container
      v-if="!uiStore.isLoading"
      class="target align-end pa-0 mr-4 d-flex flex-column"
