...
export const ACTION = [
  { id: "donate", title: "小額支持喵喵", content: "您的小筆捐款，是每隻毛孩未來的大大動力！", button: "小額捐款", imgSrc: donate }, { id: "mail", title: "民眾服務信箱", content: "親愛的鄉親，每一位市民的意見都是我們社區前進的原動力", button: "填寫表單", imgSrc: mail }
]