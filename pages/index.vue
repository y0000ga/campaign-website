<template>
  <div>
    ...
    <v-container class="pa-0">
      ...
      >
        <v-img
          :aspect-ratio="723 / 404"
          :src="mainBg"
          class="absolute mainBg"
        />
    ...
    <v-container :class="fullContainerClass" id="advocate">
      <v-card
        class="rounded-xl d-flex shadow-md about"
        variant="elevated"
        data-aos="zoom-in"
        data-aos-duration="500"
      ...
      >
        <v-container
          class="w-50 d-flex align-center flex-column px-10 justify-center"
        >
          <main-title english-title="ADVOCATE" :title="ADVOCATE"></main-title>
          <h3 class="text-h3 my-8">
            我堅信 ! 藉由推動更完善的<span class="text-primary">貓咪福利</span
            >和相關政策，更是間接地投資於<span class="text-primary">{{
              TAIWAN_FUTURE
            }}</span
            >。
          </h3>
    ...
    <v-container class="flex-center flex-column mainBlock" id="activity"
      ><main-title
        data-aos="zoom-in"
        data-aos-duration="500"
        data-aos-anchor-placement="center-bottom"
      ...
      <v-card class="d-flex mt-10 ga-6 max-w-primary activity" variant="flat">
        ...
        ></activity-card>
        <v-container
          class="pa-0 d-flex flex-column relative ga-7"
          data-aos="fade-left"
          data-aos-anchor-placement="center-bottom"
          data-aos-duration="500"
        >
          <activity-card
            ...
            :id="activity.id"
          ></activity-card>
          <base-button icon="mdi-arrow-right" theme="gray"
            >查看更多</base-button
          >
        </v-container>
      </v-card>
    </v-container>
    <v-container :class="fullContainerClass" id="policy"
      ><main-title
        data-aos="zoom-in"
        data-aos-anchor-placement="center-bottom"
...
const message = ref('政策議題')

const fullContainerClass =
  'max-w-full bg-background-secondary flex-column flex-center'
